    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "car",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cabin.Car"
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "rider",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="cabin.Rider"
                    ),
                ),
            ],
        ),
        migrations.AddField(
            ...
            field=models.OneToOneField(
                on_delete=django.db.models.deletion.CASCADE, to="cabin.RideRequest"
            ),
        ),
        migrations.AddField(
            model_name="payment",
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="cabin.Ride"
            ),
        ),
        migrations.AddField(
            model_name="car",
            name="owner",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="cabin.Driver"
            ),
        ),
